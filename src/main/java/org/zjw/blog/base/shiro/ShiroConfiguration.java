...
//        filters.put("logout",null);
        ...
        filterChainDefinitionManager.put("/styles*", "anon");
        filterChainDefinitionManager.put("/validatecode.jsp", "anon");
        filterChainDefinitionManager.put("/logout", "logout");
        filterChainDefinitionManager.put("/admin/first", "user");
        filterChainDefinitionManager.put("/welcome.jsp", "user");//用户为ROLE_USER 角色可以访问。由用户角色控制用户行为。
