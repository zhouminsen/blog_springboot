    ...
    <script type="text/javascript">
        ...
        function deleteRole() {
            ...
            $.messager.confirm("系统提示", "您确认要删除这<font color=red>" + selectedRows.length + "</font>条数据吗？", function (r) {
                if (r) {
                    $.post("${cxt}/admin/role/delete", {ids: ids}, function (result) {
                        if (result.success) {
        ...
        function openRoleUpdateDialog() {
            ...
            url = "${cxt}/admin/role/modify?roleId=" + row.roleId;
        }
        ...
        function openMenuDialog() {
            ...
            url = "${cxt}/admin/menu/chooseMenu?parentId=-1&roleId=" + roleId;
            // 加载所有权限的树
            $("#tree").tree({
                lines: true,
                url: url,
        ...
        function saveMenu() {
            ...
            $.post("${cxt}/admin/role/modifyRoleMenu", {menuIds: menuIds, roleId: roleId}, function (result) {
                if (result.success) {
...
<table id="dg" class="easyui-datagrid" fitColumns="true"
       pagination="true" rownumbers="true" url="${cxt}/admin/role/list" fit="true" toolbar="#tb">
    <thead>
    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="roleId" width="50" align="center">编号</th>
        <th field="roleName" width="100" align="center">角色名称</th>
        <th field="description" width="200" align="center">备注</th>
    </tr>
    </thead>
</table>
...
<div id="tb">
    ...
    <div>
        <a href="javascript:void(0)" operationId="角色管理:添加" class="easyui-linkbutton" onClick="openRoleAddDialog()"
           name="添加" plain="true" iconCls="icon-add">添加</a>
        <a href="javascript:void(0)" operationId="角色管理:修改" class="easyui-linkbutton" onClick="openRoleUpdateDialog()"
           name="修改" plain="true" iconCls="icon-edit">修改</a>
        <a href="javascript:void(0)" operationId="角色管理:删除" class="easyui-linkbutton" onClick="deleteRole()"
           name="删除" plain="true" iconCls="icon-remove">删除</a>
        <a href="javascript:void(0)" operationId="角色管理:授权" class="easyui-linkbutton" onClick="openMenuDialog()"
           name="授权" plain="true" iconCls="icon-edit">授权</a>
    </div>
    <div class="updownInterval"></div>
    <div>
